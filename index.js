...
//client.hmset('frameworks_hash', 'header', 0, 'left', 0, 'article', 0, 'right', 0, 'footer', 0);
...
function data() {
  ...
  return new Promise ( (resolve, reject) => {
    client.mget(['header', 'left', 'article', 'footer', 'right'], (err, value) => {
      const data = {
...
app.get("/update/:key/:value", function (req, res) {
  ...
  client.get(key, (err, reply) => {
    ...
    client.set(key, value + Number(reply));
